          ...
          <div className="col label">
            <div className="form-group">
              <div className="input-group">
                <input id="field1" type="text" className="form-control add" placeholder="Input Your List" name="todo" onChange={handleinput} />
                <span className="input-group-btn">
                  <button className="btn btn-danger add ms-2" type="button" onClick={handleadd}>
                    Add 
                  </button>
                </span>
              </div>
          ...
          <>
            <div className="row">
              <div className="col label">
                <div className="form-group">
                  <div className="input-group">
                    <input id="field1" type="text" className="form-control add" placeholder="Change List" name="todo" onChange={edittext} />
                    <span className="input-group-btn">
                      <button className="btn btn-danger add ms-2" name="todo" type="button" onClick={() => handleedit(idedit)}>
                        Change
                      </button>
                    </span>
                  </div>
        ...
        <div className="container">
          <div className="row label d-flex justify-content-between">
            <div>
              ...
              <button className={`btn add ms-2 ${selected === "Active" ? "btn-danger add" : "btn add"}`} name="Active" type="button" onClick={handlepick}>
                Active
              </button>
              <button className={`btn add ms-2 ${selected === "Completed" ? "btn-danger add" : "btn add"}`} name="Completed" type="button" onClick={handlepick}>
                Completed
              </button>
            </div>
          </div>
